...
class Errors{
    ...
    const ERROR_LOGIN_AUTHENTICATE_EXISTS        = "1231ljbh23jkgh12c3hn12371tiyamns";
    ...
    const ERROR_SIGNUP_NEWUSER_DATA              = "aijsbdas97d6asdbamcsd78atdgkjasb";
    ...
    public function __construct()
    {
        $this->errorsList = [
            ...
            Errors::ERROR_LOGIN_AUTHENTICATE_EXISTS => 'No existe ese username o email en nuestra base de datos',
            ...
            Errors::ERROR_SIGNUP_NEWUSER_DATA       => 'No existen los campos necesarios para registrarte',
