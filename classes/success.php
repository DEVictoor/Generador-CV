...
class Success{
    ...
    const SUCCESS_USER_LOGIN            = "asdasdas98d7a9sdhjkasbnda9s678da";
    const SUCCESS_SIGNUP_NEWUSER        = "8281e04ed52ccfc13820d0f6acb0985a";
    const SUCCESS_ADMIN_UPDATE          = "8281e04ed52ccfc13820d0f6acb09851212";
    const SUCESS_HOMEPAGE_UPDATE        = "8281e04ed52ccfc13820d0f6acb09851231";
    ...
    public function __construct()
    {
        $this->successList = [
            ...
            Success::SUCCESS_USER_LOGIN => "Usuario logeado correctamente",
            Success::SUCCESS_ADMIN_UPDATE => "Datos actualizados con exito",
            Success::SUCESS_HOMEPAGE_UPDATE => "Homepage actualizao con exito"
        ];
    }
