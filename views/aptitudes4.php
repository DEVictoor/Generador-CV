                ...
                <div class="card card-primary">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-sm">
                                <div id="title" class="d-flex justify-content-center col-sm-12">
                                    <p class="mb-0">Take a last preview</p>
                                </div>
                            </div> 
                    ...
                    <div class="card-footer">
                        <div class="d-flex">
                            ...
                            <a href="<?php echo constant('URL') . 'create/aptitudes/3?idcv=' . $_GET['idcv']; ?>"><button type="button" class="btn btn-secondary">Back</button>                            </a>
                            </div>
                            <div class="p-2">
                            <a href="<?php echo constant('URL') . 'create/final?idcv=' . $_GET['idcv']; ?>"><button type="button" class="btn btn-dark">Next</button>     </a>
                            </div>
                        </div>
                    </div>
                </div>
