                ...
                <div class="card card-primary">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="mr-auto p-2">
                                <a href="<?php echo constant('URL') . 'create/works/2?idcv=' . $_GET['idcv'];?>"><button id="btn-back-next" type="submit" class="btn btn-secondary">Back</button></a>
                            </div>
                            <div class="p-2">
                            <a href="<?php echo constant('URL') . 'create/vocations/1?idcv=' . $_GET['idcv'];?>"><button id="btn-back-next" type="submit" class="btn btn-dark">Next</button></a>    
                            </div>
                        </div>
                    </div>
                </div>
